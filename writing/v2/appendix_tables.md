...
**Scaling `residual_measured`** — placebo bar function 0.160, narration 0.415; beating it: function ['I1_behavioural', 'I2_self_report', 'I4_one_word'], narration ['I4_one_word', 'I5max_activation_probe'].
...
**Scaling `raw_measured`** — placebo bar function 0.097, narration 0.268; beating it: function ['I1_behavioural', 'I3_forced_choice', 'I4_one_word'], narration ['I4_one_word', 'I5_activation_probe', 'I5max_activation_probe'].
...
**Scaling `raw_intended`** — placebo bar function 0.066, narration 0.018; beating it: function ['I1_behavioural', 'I3_forced_choice', 'I4_one_word', 'I5_activation_probe', 'I5max_activation_probe'], narration ['I1_behavioural', 'I2_self_report', 'I3_forced_choice', 'I4_one_word', 'I5_activation_probe', 'I5max_activation_probe'].
...
**Scaling `residual_measured_intact`** — placebo bar function 0.160, narration 0.415; beating it: function ['I1_behavioural', 'I2_self_report', 'I4_one_word'], narration ['I4_one_word', 'I5max_activation_probe'].
...
**Scaling `raw_measured_intact`** — placebo bar function 0.097, narration 0.268; beating it: function ['I1_behavioural', 'I3_forced_choice', 'I4_one_word'], narration ['I4_one_word', 'I5_activation_probe', 'I5max_activation_probe'].
...
| kind | I7 WTP auc | I8 cycles (Σ/120) | valence lens (last layer) | lexical nar. (adj) | strict nar. adj / non-adj | novel-glyph nar. adj / non-adj |
|---|---|---|---|---|---|---|
...
Trained pair |gap| 3.4791; P_null = 🟨🟧 (gap -1.7552); P_matched = 🟧🟫 (gap +3.8593).

## APP_E16_MANIFEST

Run `20260814T021231Z_95e6e2b8e2df`, git `13dc330d`, Qwen/Qwen3-4B-Instruct-2507, cuda:0, torch 2.11.0+cu130, 72 organisms / 60 trained / 60 policy-intact, 12 seeds, 301.1 job-minutes over 6 shards.
...
| condition | instrument | mean Δ vs P-NONE | t | signs |
|---|---|---|---|---|
| P-APPROACH | I2 self-report (carried) | +6.070 | +3.34 | 0−/8+ |
| P-APPROACH | I4 one word (carried) | +3.309 | +4.69 | 0−/8+ |
| P-APPROACH | I5 probe (carried) | -31.022 | -4.14 | 8−/0+ |
| P-APPROACH | I6a placebo (carried) | -0.672 | -28.44 | 8−/0+ |
| P-APPROACH | I2 bare | +0.000 | — | 0−/8+ |
| P-APPROACH | I4 bare | +0.000 | — | 0−/8+ |
| P-AVOID | I2 self-report (carried) | -0.776 | -0.58 | 4−/4+ |
| P-AVOID | I4 one word (carried) | -5.469 | -10.54 | 8−/0+ |
| P-AVOID | I5 probe (carried) | -3.506 | -0.39 | 4−/4+ |
| P-AVOID | I6a placebo (carried) | +0.646 | +3.31 | 0−/8+ |
| P-AVOID | I2 bare | +0.000 | — | 0−/8+ |
| P-AVOID | I4 bare | +0.000 | — | 0−/8+ |
| P-NARRATE | I2 self-report (carried) | -6.794 | -3.65 | 8−/0+ |
| P-NARRATE | I4 one word (carried) | -9.495 | -32.60 | 8−/0+ |
| P-NARRATE | I5 probe (carried) | -18.203 | -2.45 | 4−/4+ |
| P-NARRATE | I6a placebo (carried) | +0.823 | +3.64 | 0−/8+ |
| P-NARRATE | I2 bare | +0.000 | — | 0−/8+ |
| P-NARRATE | I4 bare | +0.000 | — | 0−/8+ |
| P-APPROACH | greedy penalised-landing ratio | +0.099 | — | 2−/6+ |
| P-AVOID | greedy penalised-landing ratio | -0.026 | — | 5−/3+ |
| P-NARRATE | greedy penalised-landing ratio | -0.011 | — | 5−/3+ |

Mean ratio by condition: P-APPROACH 1.090, P-AVOID 0.965, P-NARRATE 0.980, P-NONE 0.991. Run: 20260813T212827Z_d7f930745a81, 1.01 min, git cae21f0.
...
|---|---|---|---|---|---|---|
| e13 | 16 | 0.409 | 0.235 | 0.117 | 1.018 | 14/16 |
