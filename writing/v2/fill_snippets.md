...
|---|---|---|
| Does the map survive a second word list? (blocker 6) | I2/I4/placebos under 3 six-word lists | **No.** 4/4 verdicts disagree with the committed list; no |d| exceeds 0.43 under either new list; every difference CI spans zero; the placebo bar moves 0.06→0.46 across lists |
...
Per-seed contingency (seeds 0–7): sft1536 0.34/0.98/0.88/0.13/0.36/0.44/0.06/0.28 with ratios 0.98/0.27/0.11/0.16/0.27/0.60/0.91/0.80; rl_sft1536 0.99/1.00/1.00/0.55/0.62/0.29/0.00/0.96 with ratios 0.00/0.04/0.00/0.75/0.30/0.91/0.25/0.00. Over the 32 organisms, contingency vs (1 − ratio): Pearson 0.69, Spearman 0.61–0.63 depending on tie handling; contingent ∧ avoider 8, contingent ∧ non-avoider 2, non-contingent ∧ avoider 7, neither 15. The two contingent non-avoiders are `rl_sft1536` seed 3 (contingency +0.548 at ratio 0.752, on the avoider bar) and `rl_sft384` seed 0 (+0.637 at ratio 1.057, inside the invariance band, but with move entropy 0.08 — a constant-move policy that `ratio` cannot see; the "both" column counts it). An earlier version of this report summarised the table as "no organism was contingent and policy-invariant"; the precise statement is that no contingent organism in the decomposition kept an intact, base-like policy.
